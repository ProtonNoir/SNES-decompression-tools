...
ifstream in_file ("Claymates (U) [!].smc", ios::in | ios::binary);
...
unsigned short _decompressionSize=0x09d0;
...
ofstream out_file ("Claymates (U) [!]_decomp.bin", ios::out | ios::binary);
