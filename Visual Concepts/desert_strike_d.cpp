...
ifstream in_file ("Desert Strike - Return to the Gulf (U) [!].smc", ios::in | ios::binary);
...
ofstream out_file ("Desert Strike - Return to the Gulf (U) [!]_decomp.bin", ios::out | ios::binary);
