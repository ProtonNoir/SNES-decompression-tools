...
int main(int argc, char **argv)
{
    ...
    const unsigned int POINTER_SIZE=0x1000;
    ...
    uint32_t a_off = 0x0AD0DA;
    uint32_t b_off = 0x0AD0DB;
    uint32_t c_off = 0x0AD0DC;
    
    uint32_t p_off = 0x0AD0DD;    
    
    uint32_t in_off = 0x0AE0DD;
  ...
  //  uint16_t comp_size;
    ...
    const char* in_name = "Sky Blazer (U) [!].smc";
    const char* out_name = "Sky Blazer (U) [!]_decomp.bin";
