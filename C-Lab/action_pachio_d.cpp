...
ifstream in_file ("Action Pachio (J).smc", ios::in | ios::binary);
...
//while (_inputPosition<_decompressionSize)
{	
...
ofstream out_file ("Action Pachio (J)_decomp.bin", ios::out | ios::binary);
