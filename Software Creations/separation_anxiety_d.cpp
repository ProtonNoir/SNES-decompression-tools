...
int main(int argc, char **argv)
{
    ...
    uint32_t in_off = 0x0D2D9A; 
    uint32_t c_off = 0x0D2D98;
  ...
  //  uint16_t comp_size;
    ...
    const char* in_name = "Spider-Man & Venom - Separation Anxiety (U).smc";
    const char* out_name = "Spider-Man & Venom - Separation Anxiety (U)_decomp.bin";
