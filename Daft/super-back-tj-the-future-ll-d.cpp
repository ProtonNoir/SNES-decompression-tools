...
ifstream in_file ("Super Back to the Future Part II (J).smc", ios::in | ios::binary);
...
ofstream out_file ("Super Back to the Future Part II (J)_decomp.bin", ios::out | ios::binary);
